...
* Project summary: paid-by breakdown showing how much each person contributed (amount + percentage of the total spent), with avatars; payer is also displayed inline on each linked transaction
